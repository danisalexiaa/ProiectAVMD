...
st.write('Importanta caracteristicilor - observam ca f1 este cea mai importanta caracteristica (Credit Amount), indicand faptul ca valoarea creditului are o importanta mai mare in evaluarea riscului.')
